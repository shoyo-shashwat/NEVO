...
def create_app(config_class=Config):
    ...
    # ------------------------------------------------------------------
    from app.services.mplads_ledger import rupees as _rupees
    app.jinja_env.filters["rupees"] = _rupees

    _STATE_LABELS = {
        "ALIGNED": "Already covered",
        "PARTIALLY_ADDRESSED": "Partly covered",
        "UNADDRESSED": "No funding yet",
        "IMPLEMENTATION_ACCESS_GAP": "Scheme not reaching people",
        "EMERGING_GAP": "Growing faster than coverage",
    }
    app.jinja_env.filters["state_label"] = lambda v: _STATE_LABELS.get(v, str(v).replace("_", " ").capitalize())
